...
class Ireland:
    ...
    def pipe_corrections_2_dose(self, ds: pd.Series) -> pd.Series:
        ds.loc["people_fully_vaccinated"] = ds.people_vaccinated + ds.johnson
        return ds
    ...
    def pipeline(self, ds: pd.Series) -> pd.Series:
        return (
            ...
            .pipe(self.pipe_corrections_2_dose)
            .pipe(self.pipe_date)
